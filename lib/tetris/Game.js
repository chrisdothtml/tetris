...
export default class Game {
  ...
  clone () {
    ...
    clonedGame._grid = this._grid
    clonedGame.frameCount = this.frameCount
    clonedGame.gameOver = this.gameOver
    clonedGame.gridSize = this.gridSize
    clonedGame.score = this.score

    if (this.item) {
      clonedGame.item = this.item.clone()
    }

    if (this.nextItem) {
      clonedGame.nextItem = this.nextItem.clone()
    }
